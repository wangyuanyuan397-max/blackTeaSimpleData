...
@LOSSES.register("ce_with_aux_regression")
class CEWithAuxRegressionLoss(nn.Module):
    """Joint 4-class CE + auxiliary continuous regression loss."""
    ...
    def __init__(
        ...
        super().__init__()
        self.classification_loss = nn.CrossEntropyLoss(label_smoothing=float(label_smoothing or 0.0))
