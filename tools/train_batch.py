...
COMMON_CONFIG = Path('configs/fixed_split_01234_BaSic_grid30_408_train.yaml')
CONFIG_LIST = (
    # SAFNet 论文/源码对比队列。四项共享 01234 BaSiC grid30 408 公共配置，
    # 因而使用完全相同的五分类数据划分、输入、优化器、轮数和测试流程。
