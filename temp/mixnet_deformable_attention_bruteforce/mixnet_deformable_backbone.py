"""Local MixNet-S backbone with optional deformable attention after resolution stages."""
...
class MixNetSDeformableBackbone(nn.Module):
    """MixNet-S with deformable attention inserted after selected spatial stages."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if model_name != "mixnet_s":
            raise ValueError("This experiment fixes model_name to mixnet_s.")
