...
class DeformableAttention2d(nn.Module):
    ...
    def __init__(
        ...
        self.value_proj = nn.Conv2d(self.channels, self.channels, kernel_size=1, bias=True)
        ...
        self.output_proj = nn.Conv2d(self.channels, self.channels, kernel_size=1, bias=True)
